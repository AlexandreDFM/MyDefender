...
defender_t init4(defender_t d)
{
    ...
    d.map_select_d = create_go("maps/map_select.png", (sfVector2f) {314, 783}, (sfIntRect) {3947, 0, 96, 98}, (sfVector2f) {0.62888961677, 0.59965034965});
    d.map_select_go = create_bouton("maps/map_select.png", (sfVector2f) {885 - 159 / 2, 875}, (sfIntRect) {4576, 0, 159, 43});
    d.map_select = 1;
    return d;
}
